...
//Mock data
import { topTopics, topTechnologies, topEngineers, topProjects, topTopicsGrowing, topTechnologyGrowing } from "@/mockData/mockAgriculture";
...
export default async function LayoutEcosystem(props: layoutEcosystemProps){
    ...
    if(props.subDomains){
        result = await apiCallSubEcosystem("agriculture", props.subDomains)
    } else {
